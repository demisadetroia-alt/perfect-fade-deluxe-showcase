...
import {
  ...
  ZoomIn, ZoomOut, X, Award, Gem, Sparkles, Navigation,
} from "lucide-react";
      ...
      <section id="dove-siamo" className="py-28 px-6 bg-secondary/30 border-t border-border">
        <div className="max-w-5xl mx-auto">
          ...
          <FadeIn delay={150} className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href={PHONE_LINK}
              className="inline-flex items-center justify-center gap-2 border border-gold/40 text-gold px-8 py-4 rounded-full font-medium hover:bg-gold hover:text-primary-foreground transition"
            >
          ...
          <FadeIn delay={250} className="mt-14 grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            ...
            <InfoRow
              ...
              title="Telefono"
            >
              <a href={PHONE_LINK} className="hover:text-gold transition">
                {PHONE}
              </a>
            </InfoRow>
          </FadeIn>
